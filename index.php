        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="datamaster" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="?page=vendor">Vendor</a>
                                    <a class="nav-link" href="?page=barang">Barang</a>
                                    <a class="nav-link" href="?page=kategori_toko">Kategori Toko</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <?php 
                    ...
                    if($page == "kategori_toko") {
                        if ($aksi == "") {
                            include "page/kategori_toko/kategori_toko.php";
                        }
                        if ($aksi == "tambah") {
                            include "page/kategori_toko/tambah.php";
                        }
